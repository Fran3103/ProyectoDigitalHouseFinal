package backend.backend.Controlers;
...
import backend.backend.Entities.Imagenes;
import backend.backend.Entities.Producto;
import backend.backend.Repositories.ProductoRepository;
import backend.backend.Repositories.ImagenesRepositories;
